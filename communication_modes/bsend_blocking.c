...
int main(int argc, char *argv[])
{
    ...
    if (rank == 0)
    {
        ...
        printf("Master using MPI_Bsend...\n");
        MPI_Bsend(data, 4, MPI_INT, 1, 0, MPI_COMM_WORLD);

        printf("Master finished MPI_Bsend.\n");
...
$ mpiexec -n 2 bsend_blocking

Master using MPI_Bsend...
Master finished MPI_Bsend.
